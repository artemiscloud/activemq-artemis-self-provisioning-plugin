...
const Authentification: FC<JolokiaPropTypes> = ({
  children,
  brokerCR,
  podOrdinal,
}) => {
...
export const JolokiaAuthentification: FC<JolokiaPropTypes> = ({
  children,
  brokerCR,
  podOrdinal,
}) => {
  ...
  return (
    <QueryClientProvider client={querClient}>
      <Authentification brokerCR={brokerCR} podOrdinal={podOrdinal}>
        {children}
      </Authentification>
    </QueryClientProvider>
  );
