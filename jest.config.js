module.exports = {
  ...
  transformIgnorePatterns: [
    '<rootDir>/node_modules/(?!(@patternfly|@patternfly/react-icons|@openshift-console\\S*?|@novnc|@popperjs|lodash|monaco-editor|react-monaco-editor|byte-size|lodash-es)/.*)',
  ],
  moduleNameMapper: {
